...
public class UseTimeAdapter extends BaseAdapter {
    ...
    private  List<ResGetDurationRanking.DurationRankBean> list;
    private LayoutInflater mInflater;//布局装载器对象
    private int mView;

    public UseTimeAdapter(Context context , List<ResGetDurationRanking.DurationRankBean> list,int viewType) {
    ...
    public void upDateAdapter(List<ResGetDurationRanking.DurationRankBean> mDatas){
        this.list =mDatas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_number.setText(list.get(position).getCount()+"分钟");
