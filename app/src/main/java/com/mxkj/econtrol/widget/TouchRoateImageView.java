 ...
 * @since 2013-02-22
 */
public class TouchRoateImageView extends android.support.v7.widget.AppCompatImageView {

    private final static float MIN_DEGREE = -90f;
    private final static float MAX_DEGREE = 90f;
    private DegreeChangeLinstenter mLinstenter;
    ...
    private void handleTouchUp() {
        ...
        if (mLinstenter != null) {
            ...
            mLinstenter.onDegreeChange(dstDegree);
        }
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(curDegree, dstDegree);
        valueAnimator.setDuration(350);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                curDegree = (float) animation.getAnimatedValue();
    ...
    public void setCurDegree(float degree) {
        if (degree >= MIN_DEGREE && degree <= MAX_DEGREE) {
            ...
            ValueAnimator valueAnimator = ValueAnimator.ofFloat(this.curDegree, degree);
            valueAnimator.setDuration(350);
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
    ...
    public void setDegreeChangeLinstenter(DegreeChangeLinstenter mLinstenter) {
        this.mLinstenter = mLinstenter;
    }

    public interface DegreeChangeLinstenter {
