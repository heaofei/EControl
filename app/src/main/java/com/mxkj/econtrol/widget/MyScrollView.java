...
public class MyScrollView extends ScrollView {
    ...
    // 是否允许下拉
    private boolean mPutdown = true;
    // 是否允许上拉
    private boolean mPutup = true;
    ...
    public MyScrollView(Context context, AttributeSet attrs) {
        ...
        mPutdown = typedArray.getBoolean(R.styleable.MyScrollView_putdown,true); // 默认允许上拉， 下拉回弹
        mPutup = typedArray.getBoolean(R.styleable.MyScrollView_putup,true);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if ( !mPutdown && isCanPullDown() && deltaY > 0){ // 不允许下拉，
                    break;
            }
