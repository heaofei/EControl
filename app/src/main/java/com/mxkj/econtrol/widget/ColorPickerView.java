...
public class ColorPickerView extends View {
...

    {
        ...
        paintForIndicator.setAntiAlias(false);
...
//        paintForIndicator.setShadowLayer(radius, 0, 0, Color.GRAY);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
            ...
            if (colorPickerChangeListener != null) {
                colorPickerChangeListener.onStopTrackingTouch(this,currentColor);
                calcuColor();
                colorPickerChangeListener.onColorChanged(this, currentColor);
            }
    ...
    public interface OnColorPickerChangeListener {
         ...
         * @param picker ColorPickerView
         */
        void onStopTrackingTouch(ColorPickerView picker,int color);
    }
    ...
    public void showIndicatorEnable(boolean mIndicatorEnable) {
        this.mIndicatorEnable = mIndicatorEnable;
    }
