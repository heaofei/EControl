 ...
 *  侧滑的RecyclerView   (配合TimingListAdapter 使用)
 */
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    TimingListAdapter.MyViewHolder viewHolder = (TimingListAdapter.MyViewHolder) getChildViewHolder(view);
            ...
            case MotionEvent.ACTION_UP:
                ...
                int upScrollX = 0;
                try {
                     upScrollX = mItemLayout.getScrollX();
                }catch (Exception er){
                    er.printStackTrace();
                    break;
                }
